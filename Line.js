     ...
     <ScrollView  
        ...
        >
                  ...
                  <G x={options.margin.left} y={options.margin.top}>
                        ...
                        { areas }
                        { lines }
                       < LastCircle options={options.axisX} chart={chart}  xmax={options.margin.left} ymax={options.margin.top} />
                      <Axis key="x" scale={chart.xscale} options={options.axisX} chartArea={chartArea} mx={mx} />
                      <Axis key="y" scale={chart.yscale} options={options.axisY} chartArea={chartArea} mx={mx} />
                  </G>
              </Svg>
      </ScrollView>
